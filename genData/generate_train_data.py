...
if __name__ == '__main__':
    ...
    parser.add_argument('--file', dest='filename', type=str, help='Name of the video file.',
                        default='D:/pythonprojects/face2face-demo-master/VID_20190120_144037.mp4')
    parser.add_argument('--num', dest='number', type=int, help='Number of train data to be created.', default=1000)
    parser.add_argument('--landmark-model', dest='face_landmark_shape_file', type=str, help='Face landmark model file.',
                        default='D:/pythonprojects/face2face-demo-master/shape_predictor_68_face_landmarks.dat')
